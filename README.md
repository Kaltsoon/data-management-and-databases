...
This repository contains materials and exercises for Data Management and Databases course.
...
5. [Aggregate functions](./slides/05-aggregate-functions.pdf)
6. [Grouping and sub queries](./slides/06-grouping.pdf)
7. [Join clauses](./slides/07-join-clauses.pdf)
8. [Database design](./slides/08-database-design.pdf)
9. [Logical database design](./slides/09-logical-database-design.pdf)
10. [Database normalisation](./slides/10-database-normalisation.pdf)
11. [Physical database design](./slides/11-physical-database-design.pdf)
12. [Database transactions](./slides/12-database-transactions.pdf)
13. [SQL access control and views](./slides/13-sql-access-control-and-views.pdf)
