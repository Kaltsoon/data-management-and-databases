...
> ```
>
> In Moodle, submit a `sql_exercises_2_YOURFAMILYNAME.docx` document containing the **SQL query and a [screenshot](https://www.take-a-screenshot.org/) of the result table in each task**.
