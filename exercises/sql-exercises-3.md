...
> [!TIP]
> To understand the database structure, use the [database diagram](https://drawsql.app/teams/kaltsoon/diagrams/takkula-database-diagram). It shows the database tables, columns, primary keys and foreign keys.
