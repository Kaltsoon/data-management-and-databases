# Initialize the Takkula Tables Exercise
...
| `TAKKULA_Drop_Tables.sql`   | `DROP` statements to drop the database tables. If something goes wrong, you can drop the Takkula tables by executing this script and then you can create the tables again. |

Download the script files as a folder by clicking the "Download folder" button.
