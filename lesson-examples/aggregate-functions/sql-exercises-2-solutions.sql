...
-- 7. List all the students (city, postcode, surname, first name), 
-- who either live in the capital city of Finland within the postcode area 00400 - 00600
-- or who live in Espoo. Sort the result by (city, postcode, surname, first name) in ascending order.

-- 15. Write a query that lists those teachers 
-- whose new salary would be above 18 800 €, if they would get a rise of 500 € and an additional 15 % salary increase to the old salary.
