...
SQL Server Management Studio is the graphical user interface used to interact with the SQL Server Database Management System. This guide provides instructions on the basic usage of the SQL Server Management Studio.
...
> [!IMPORTANT]
> When we create or drop a database table by executing an SQL statement, we have to refresh the "Tables" folder in the "Object Explorer" to see the changes (which are actually applied in the database level).
>
