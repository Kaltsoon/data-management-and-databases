...
> [!CAUTION]
> You won't learn anything from the course by directly generating answers using generative AI tools (e.g, ChatGPT or Copilot). Also, such tools won't be available for you during the exam. However, using AI tools for advice such as _"Which functions gets the current date in SQL Server"_ or _"What is the difference between INNER JOIN and OUTER JOIN"_?
