...
In the Moodle's "General" tab you'll find a "SQL Server usernames" link with the properties you need to use. Once you have typed in the correct connection properties, click the "Connect" button.

![SQL Server Management Studio "Connect" dialog](./assets/ssms-connect-haaga-helia.png)

If there's no error dialog, you have successfully connected to the Haaga-Helia's SQL Server. 🎉
