# Analysis of the primary key for the Course_Grade relation
...
maximum one course grade per each student per each course. For example, it does
not accept the following new tuple to be added: `(100, swd4tf003, 2, 5)`.

Some examples of incorrect primary keys for the Course_grade relation:
